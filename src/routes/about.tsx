...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "A privately owned creative studio specializing in design, branding, and AI-driven digital innovation." },
      { property: "og:title", content: "About — Space XP" },
      { property: "og:description", content: "Who we are, our story, and the values driving Space XP forward." },
    ],
  }),
  component: AboutPage,
});
...
const milestones = [
  { n: "01", t: "Agency Founded", d: "Launched as a boutique studio with a focus on design excellence." },
  { n: "02", t: "Global Brand Partnerships", d: "Scaled rapidly through client referrals and word-of-mouth." },
  { n: "03", t: "Award-Winning Campaigns", d: "Recognized for pioneering digital design across markets." },
  { n: "04", t: "Enterprise-Scale Delivery", d: "Trusted by enterprises for mission-critical brand systems." },
];
    ...
    <>
        ...
        <div className="relative mx-auto max-w-7xl px-6 pb-12">
          <Reveal>
            ...
            <h1 className="mt-4 max-w-5xl font-display text-5xl leading-[0.95] md:text-7xl lg:text-8xl">
              A creative studio where <span className="text-gradient">imagination meets execution.</span>
            </h1>
          </Reveal>
        </div>
      </section>
        ...
        <div className="grid gap-12 md:grid-cols-2">
          <Reveal>
            ...
            <h2 className="mt-3 font-display text-3xl md:text-4xl">
              To be the most trusted creative partner for brands seeking transformative digital and visual identities.
            </h2>
          </Reveal>
          <Reveal delay={120}>
            <p className="font-mono text-xs uppercase tracking-widest text-primary">Mission</p>
            <h2 className="mt-3 font-display text-3xl md:text-4xl">
              To harness research, craftsmanship and AI to create refined identities, websites, campaigns, and experiences that drive lasting growth.
            </h2>
          </Reveal>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-7xl px-6 py-20">
        <Reveal>
          ...
          <h2 className="mt-3 font-display text-4xl md:text-6xl">A journey of <span className="text-gradient">achievements.</span></h2>
        </Reveal>
      ...
      <section className="mx-auto max-w-7xl px-6 py-20">
        <Reveal>
          ...
          <h2 className="mt-3 font-display text-4xl md:text-6xl">Meet the <span className="text-gradient">crew.</span></h2>
        </Reveal>
        <div className="mt-12 grid gap-px overflow-hidden rounded-2xl border border-border bg-border md:grid-cols-2 lg:grid-cols-4">
          {team.map((m, i) => (
            <Reveal key={m.name} delay={i * 80}>
              <div className="group relative aspect-[3/4] overflow-hidden bg-card" data-cursor="hover">
                <div className="bg-grid absolute inset-0 opacity-30" />
                ...
                <div className="absolute inset-0 flex flex-col justify-end p-6">
                  ...
                  <p className="font-mono text-xs uppercase tracking-widest text-muted-foreground">{m.role}</p>
                </div>
              </div>
            </Reveal>
          ))}
